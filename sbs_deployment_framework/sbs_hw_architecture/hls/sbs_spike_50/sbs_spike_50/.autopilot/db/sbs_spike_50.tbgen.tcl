set C_TypeInfoList {{ 
"sbs_spike_50" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"stream_in": [[], {"reference": "0"}] }, {"stream_out": [[], {"reference": "0"}] }, {"debug": [[],{ "pointer":  {"scalar": "int"}}] }, {"layerSize": [[], {"scalar": "int"}] }, {"vectorSize": [[], {"scalar": "int"}] }],[],""], 
...
set C_modelArgMapList {[ 
	{ "Name" : "stream_in_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "stream_in.V.data.V","cData": "int32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "debug", "interface" : "axi_slave", "bundle":"CRTL_BUS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "debug","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":16}, "offset_end" : {"out":23}} , 
 	{ "Name" : "layerSize", "interface" : "axi_slave", "bundle":"CRTL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "layerSize","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	{ "Name" : "vectorSize", "interface" : "axi_slave", "bundle":"CRTL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "vectorSize","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":32}, "offset_end" : {"in":39}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_CRTL_BUS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CRTL_BUS", "role": "AWADDR" },"address":[{"name":"sbs_spike_50","role":"start","value":"0","valid_bit":"0"},{"name":"sbs_spike_50","role":"continue","value":"0","valid_bit":"4"},{"name":"sbs_spike_50","role":"auto_start","value":"0","valid_bit":"7"},{"name":"layerSize","role":"data","value":"24"},{"name":"vectorSize","role":"data","value":"32"}] },
	...
	{ "name": "s_axi_CRTL_BUS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CRTL_BUS", "role": "ARADDR" },"address":[{"name":"sbs_spike_50","role":"start","value":"0","valid_bit":"0"},{"name":"sbs_spike_50","role":"done","value":"0","valid_bit":"1"},{"name":"sbs_spike_50","role":"idle","value":"0","valid_bit":"2"},{"name":"sbs_spike_50","role":"ready","value":"0","valid_bit":"3"},{"name":"sbs_spike_50","role":"auto_start","value":"0","valid_bit":"7"},{"name":"debug","role":"data","value":"16"}, {"name":"debug","role":"valid","value":"20","valid_bit":"0"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "debug", "Type" : "Vld", "Direction" : "O"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sbs_spike_50_CRTL_BUS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sbs_spike_50_faddbkb_U1", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sbs_spike_50_fcmpcud_U2", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	sbs_spike_50 {
		...
		stream_out_V_data_V {Type O LastRead -1 FirstWrite 21}
		stream_out_V_keep_V {Type O LastRead -1 FirstWrite 21}
		stream_out_V_strb_V {Type O LastRead -1 FirstWrite 21}
		stream_out_V_user_V {Type O LastRead -1 FirstWrite 21}
		stream_out_V_last_V {Type O LastRead -1 FirstWrite 21}
		stream_out_V_id_V {Type O LastRead -1 FirstWrite 21}
		stream_out_V_dest_V {Type O LastRead -1 FirstWrite 21}
		debug {Type O LastRead -1 FirstWrite 1}
...
set Spec2ImplPortList { 
	...
	stream_out_V_dest_V { axis {  { stream_out_TVALID out_vld 1 1 }  { stream_out_TREADY out_acc 0 1 }  { stream_out_TDEST out_data 1 6 } } }
}
