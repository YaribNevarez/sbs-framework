...
#ifndef __sbs_spike_50_fcmpcud__HH__
#define __sbs_spike_50_fcmpcud__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sbs_spike_50_fcmpcud) {
    ...
    SC_CTOR(sbs_spike_50_fcmpcud):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
