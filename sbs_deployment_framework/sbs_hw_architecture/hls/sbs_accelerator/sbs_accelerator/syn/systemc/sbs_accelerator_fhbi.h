...
#ifndef __sbs_accelerator_fhbi__HH__
#define __sbs_accelerator_fhbi__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sbs_accelerator_fhbi) {
    ...
    SC_CTOR(sbs_accelerator_fhbi):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
