...
set ID 10
set MemName sbs_accelerator_sbkb
...
# Memory (RAM/ROM)  definition:
set ID 11
set MemName sbs_accelerator_scud
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 31
set AddrRange 3600
...
# Memory (RAM/ROM)  definition:
set ID 12
set MemName sbs_accelerator_tdEe
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 1024
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 13 \
			corename sbs_accelerator_CRTL_BUS_axilite \
			name sbs_accelerator_CRTL_BUS_s_axi \
			ports {$port_CRTL_BUS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sbs_accelerator_CRTL_BUS_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_out_TVALID { O 1 bit } stream_out_TREADY { I 1 bit } stream_out_TDEST { O 6 vector } } \
} "
} else {
