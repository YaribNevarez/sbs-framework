...
set C_modelName {sbs_fixedpoint}
...
set C_modelArgList {
	...
	{ layerSize int 32 regular {axi_slave 0}  }
	{ kernelSize int 32 regular {axi_slave 0}  }
	{ vectorSize int 32 regular {axi_slave 0}  }
	{ epsilon int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "stream_in_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "stream_in.V.data.V","cData": "int32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "layerSize", "interface" : "axi_slave", "bundle":"CRTL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "layerSize","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "kernelSize", "interface" : "axi_slave", "bundle":"CRTL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "kernelSize","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	{ "Name" : "vectorSize", "interface" : "axi_slave", "bundle":"CRTL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "vectorSize","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":32}, "offset_end" : {"in":39}} , 
 	{ "Name" : "epsilon", "interface" : "axi_slave", "bundle":"CRTL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "epsilon","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":40}, "offset_end" : {"in":47}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_CRTL_BUS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CRTL_BUS", "role": "AWADDR" },"address":[{"name":"sbs_fixedpoint","role":"start","value":"0","valid_bit":"0"},{"name":"sbs_fixedpoint","role":"continue","value":"0","valid_bit":"4"},{"name":"sbs_fixedpoint","role":"auto_start","value":"0","valid_bit":"7"},{"name":"layerSize","role":"data","value":"16"},{"name":"kernelSize","role":"data","value":"24"},{"name":"vectorSize","role":"data","value":"32"},{"name":"epsilon","role":"data","value":"40"}] },
	...
	{ "name": "s_axi_CRTL_BUS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CRTL_BUS", "role": "ARADDR" },"address":[{"name":"sbs_fixedpoint","role":"start","value":"0","valid_bit":"0"},{"name":"sbs_fixedpoint","role":"done","value":"0","valid_bit":"1"},{"name":"sbs_fixedpoint","role":"idle","value":"0","valid_bit":"2"},{"name":"sbs_fixedpoint","role":"ready","value":"0","valid_bit":"3"},{"name":"sbs_fixedpoint","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "7", "8", "9", "10"],
		...
		"Port" : [
			...
			{"Name" : "layerSize", "Type" : "None", "Direction" : "I"},
			{"Name" : "kernelSize", "Type" : "None", "Direction" : "I"},
			{"Name" : "vectorSize", "Type" : "None", "Direction" : "I"},
			{"Name" : "epsilon", "Type" : "None", "Direction" : "I"},
			{"Name" : "ip_index", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "channel_keep_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "channel_strb_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "channel_user_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "channel_last_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "channel_id_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "channel_dest_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "random_value_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "sum_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "i", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "state_vector_V", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "spike_matrix", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "temp_data_V", "Type" : "Memory", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.state_vector_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.spike_matrix_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.temp_data_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sbs_fixedpoint_CRTL_BUS_s_axi_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_wide_div_fu_397", "Parent" : "0", "Child" : ["6"],
		"CDFG" : "wide_div",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_wide_div_fu_397.sbs_fixedpoint_udiv_63ns_42ns_63_67_0_U1", "Parent" : "5"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sbs_fixedpoint_mul_21ns_21ns_42_6_1_U5", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sbs_fixedpoint_mul_63s_42ns_63_7_1_U6", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sbs_fixedpoint_mul_43ns_21ns_63_7_1_U7", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sbs_fixedpoint_mul_mul_16ns_21ns_37_3_1_U8", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	sbs_fixedpoint {
		stream_in_V_data_V {Type I LastRead 76 FirstWrite -1}
		stream_in_V_keep_V {Type I LastRead 76 FirstWrite -1}
		stream_in_V_strb_V {Type I LastRead 76 FirstWrite -1}
		stream_in_V_user_V {Type I LastRead 76 FirstWrite -1}
		stream_in_V_last_V {Type I LastRead 76 FirstWrite -1}
		stream_in_V_id_V {Type I LastRead 76 FirstWrite -1}
		stream_in_V_dest_V {Type I LastRead 76 FirstWrite -1}
		stream_out_V_data_V {Type O LastRead -1 FirstWrite 72}
		stream_out_V_keep_V {Type O LastRead -1 FirstWrite 72}
		stream_out_V_strb_V {Type O LastRead -1 FirstWrite 72}
		stream_out_V_user_V {Type O LastRead -1 FirstWrite 72}
		stream_out_V_last_V {Type O LastRead -1 FirstWrite 72}
		stream_out_V_id_V {Type O LastRead -1 FirstWrite 72}
		stream_out_V_dest_V {Type O LastRead -1 FirstWrite 72}
		layerSize {Type I LastRead 0 FirstWrite -1}
		kernelSize {Type I LastRead 0 FirstWrite -1}
		vectorSize {Type I LastRead 0 FirstWrite -1}
		epsilon {Type I LastRead 0 FirstWrite -1}
		ip_index {Type IO LastRead -1 FirstWrite -1}
		channel_keep_V {Type IO LastRead -1 FirstWrite -1}
		channel_strb_V {Type IO LastRead -1 FirstWrite -1}
		channel_user_V {Type IO LastRead -1 FirstWrite -1}
		channel_last_V {Type IO LastRead -1 FirstWrite -1}
		channel_id_V {Type IO LastRead -1 FirstWrite -1}
		channel_dest_V {Type IO LastRead -1 FirstWrite -1}
		random_value_V {Type IO LastRead -1 FirstWrite -1}
		sum_V {Type IO LastRead -1 FirstWrite -1}
		i {Type IO LastRead -1 FirstWrite -1}
		state_vector_V {Type IO LastRead -1 FirstWrite -1}
		spike_matrix {Type IO LastRead -1 FirstWrite -1}
		temp_data_V {Type IO LastRead -1 FirstWrite -1}}
	wide_div {
