...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = sbs_fixedpoint
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = sbs_fixedpoint_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = sbs_fixedpoint
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = sbs_fixedpoint_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = sbs_fixedpoint
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = sbs_fixedpoint_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = sbs_fixedpoint_spike
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = sbs_fixedpoint_spike_0
END
