...
HD_PWD='/home/nevarez/work/vivado/sbs_fixedpoint/sbs_fixedpoint.runs/platform_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log platform_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source platform_xbar_0.tcl
