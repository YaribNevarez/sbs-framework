...
HD_PWD='/home/yarib/work/vivado/sbs_custom_float/sbs_custom_float.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log platform_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source platform_wrapper.tcl -notrace
