...
HD_PWD='/home/yarib/work/vivado/sbs_custom_float/sbs_custom_float.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log platform_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source platform_wrapper.tcl
