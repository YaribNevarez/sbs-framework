...
#
# Generated by export_simulation on Wed Mar 25 12:59:09 CST 2020
#
################################################################################
...
'-reset_run' switch to the './platform.sh' script.

./platform.sh -reset_run
...
./platform.sh -noclean_files

For more information on the script, please type './platform.sh -help'.
