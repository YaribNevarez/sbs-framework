...
proc create_root_design { parentCell } {
  ...
  # Create instance: sbs_accelerator_0, and set properties
  set sbs_accelerator_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:sbs_accelerator:1.0 sbs_accelerator_0 ]

  # Create instance: sbs_spike_50_0, and set properties
  set sbs_spike_50_0 [ create_bd_cell -type ip -vlnv Yarib:sbs:sbs_spike_50:1.0 sbs_spike_50_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins sbs_spike_50_0/stream_in]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins sbs_accelerator_0/stream_in]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins sbs_spike_50_0/s_axi_CRTL_BUS]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins sbs_accelerator_0/s_axi_CRTL_BUS]
  ...
  connect_bd_intf_net -intf_net sbs_accelerator_0_stream_out [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM] [get_bd_intf_pins sbs_accelerator_0/stream_out]
  connect_bd_intf_net -intf_net sbs_spike_50_0_stream_out [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins sbs_spike_50_0/stream_out]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_250M/slowest_sync_clk] [get_bd_pins sbs_accelerator_0/ap_clk] [get_bd_pins sbs_spike_50_0/ap_clk]
  ...
  connect_bd_net -net rst_ps7_0_250M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_250M/peripheral_aresetn] [get_bd_pins sbs_accelerator_0/ap_rst_n] [get_bd_pins sbs_spike_50_0/ap_rst_n]
  connect_bd_net -net sbs_accelerator_0_interrupt [get_bd_pins sbs_accelerator_0/interrupt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net sbs_spike_50_0_interrupt [get_bd_pins sbs_spike_50_0/interrupt] [get_bd_pins xlconcat_0/In0]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs sbs_accelerator_0/s_axi_CRTL_BUS/Reg] SEG_sbs_accelerator_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs sbs_spike_50_0/s_axi_CRTL_BUS/Reg] SEG_sbs_spike_50_0_Reg
