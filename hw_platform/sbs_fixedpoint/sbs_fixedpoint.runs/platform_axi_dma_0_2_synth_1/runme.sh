...
HD_PWD='/home/nevarez/work/vivado/sbs_fixedpoint/sbs_fixedpoint.runs/platform_axi_dma_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log platform_axi_dma_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source platform_axi_dma_0_2.tcl
