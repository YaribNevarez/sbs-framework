...
set id 1
set name sbs_fixedpoint_spike_add_64ns_64ns_64_2_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 3 \
			corename sbs_fixedpoint_spike_CRTL_BUS_axilite \
			name sbs_fixedpoint_spike_CRTL_BUS_s_axi \
			ports {$port_CRTL_BUS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sbs_fixedpoint_spike_CRTL_BUS_s_axi
}
